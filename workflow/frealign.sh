...
${OUTPUT_DIR}/analysis_diego.${N_ANALYSIS}/${CLUSTER_PATH}_umap/mrc_cluster/particles_class_${j}.mrc
...
"
  INPUT_PAR_DIR="${OUTPUT_DIR}/analysis_diego.${N_ANALYSIS}/${CLUSTER_PATH}_umap/refine3d_output/parfile_iter${i}_cluster${j}.par" #salida de refine3d / entrada de crop_par.py
  CROPPED_PAR_DIR="${OUTPUT_DIR}/analysis_diego.${N_ANALYSIS}/${CLUSTER_PATH}_umap/refine3d_output/parfile_iter${i}_cluster${j}_cropped.par" #salida de crop_par.py / entrada de star2par.py
  ...
  --par_file "${OUTPUT_DIR}/analysis_diego.${N_ANALYSIS}/${CLUSTER_PATH}_umap/refine3d_output/parfile_iter${i}_cluster${j}_cropped.par" \
  --pkl_file "${OUTPUT_DIR}/analysis_diego.${N_ANALYSIS}/${CLUSTER_PATH}_umap/particles_per_label/particles_class_${j}.pkl" \
  --output_file "${OUTPUT_DIR}/analysis_diego.${N_ANALYSIS}/${CLUSTER_PATH}_umap/refine3d_output/parfile_iter${i}_cluster${j}_cropped_index_restored.par"
done
