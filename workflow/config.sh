...
# PARTICLES_DIR="${DS_DIR}/master/read_write_scripts/example_1000/particles_example_1000.mrc"
# CTF_DIR="${DS_DIR}/master/read_write_scripts/example_1000/ctf_1000.pkl"
# POSES_DIR="${DS_DIR}/master/read_write_scripts/example_1000/poses_1000.pkl"
# INDEXES_DIR="${DS_DIR}/master/read_write_scripts/example_1000/particles_example_1000.pkl"
...
if [ "$DATASET" == "10076" ]; then
  ...
  WEIGHTING_FACTOR=10
  INVERT_CONTRAST="no"
  MRC_FILTERED_PATH="${WORK_DIR}/inputs/initial_hidden_variables/filtered_particles/filtered_L17Combine_weight_local.mrc" #Para mrcs_from_pkl.py
  if [ "$DIM" == "128" ]; then
    echo "Dim == 128"
    PARTICLES_DIR="${WORK_DIR}/downsampled_data/particles.128.mrcs"
    APIX=3.275
  ...
  if [ "$DIM" == "128" ]; then
    ...
    echo "Dim == 256"
    PARTICLES_DIR="${WORK_DIR}/downsampled_data/particles.256.txt"
    INDEXES_DIR="${WORK_DIR}/inputs/arange_empiar10180_allparticles.pkl"
    APIX=3.398
    ENC_DIM=1024
    DEC_DIM=1024
    NUM_ITER=10
    ...
    echo "Dim == 320"
    PARTICLES_DIR="${WORK_DIR}/downsampled_data/particles.orig.imod_stack.mrcs"
    INDEXES_DIR="${WORK_DIR}/inputs/filtered.ind.pkl"
    APIX=1.6999
    ENC_DIM=1024
    DEC_DIM=1024
